    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <!-- Display time zone -->
          <p>Phnom Penh,Sen sok, Cambodia</p>
        </div>
        <div class="col-md-4">
          <p>Time Zone: <?php
      ...
      <div class="row mt-4">
        <div class="col-md-12">
          <p>&copy; <?php echo date('Y'); ?> By <a href="https://github.com/E-Nat/school-management-system" target="_blank">ProjectsAndPrograms</a>. All rights reserved.</p>
        </div>
      </div>
    </div>
  </footer>
